    ...
    <main>
        <section>
            ...
            <div class="repApro">
                ...
                <button onclick="Aprovada()" id="aprovada">Aprovado</button>
            ...
            <form action="">
                <div class="just">
                    ...
                    <textarea name="rec" id="rec" cols="0" rows="3" placeholder="Digite o motivo que a solicitação foi parcialmente aprovada ou recusada."></textarea>
                    <input type="submit" value="Enviar" id="enviar">
                </div>
                <div class="aprovar">
                    <h2>Aprovar Solicitação</h2>
                    <p>Deseja aprovar esta solicitação?</p>
                    <input type="submit" value="Aprovar" id="solicitacaoAprovada">
                </div>
            </form>
        </section>
    </main>
    <script src="pastas/javascript/situaSolicitacao.js"></script>
</body>
