...
<body onresize="mudouTamanho()" >
    ...
    <main>
        ...
        <hr>
        <form action="" onsubmit="Cadastrar()" autocomplete="off">
            <div class="nome">
            ...
            <div class="quantVolt">
                <div class="quant">
                    ...
                    <input type="number" name="quant" id="quant" min="0" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
                </div>
                <div class="eltVolt">
                    <div id="eletrico">
