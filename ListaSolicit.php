...
<body onresize="mudouTamanho()">
    ...
    <main>
        ...
        <div class="listas-solicitacao">
            <label for="lista">Listas:</label>
            <select name="lista" id="lista" class="filtro">
            <option style="display:none">Escolha uma lista</option>
                <option style="pendente">Lista Pendentes</option>
                <option style="aprovado">Lista Aprovados</option>
                <option style="recusado">Lista Recusados</option>
                <option style="parcial">Lista Parcial</option>
</select>
</div>
        <fieldset>
        ...
        <form class="filtro">
            ...
            <div class="listas-solicitacao">
                ...
                <select name="lista" id="lista">
                    ...
                    <option value="primeiros">Aprovados</option>
                    <option value="ultimos">Recusados</option>
                    <option value="ultimos">Parcialmente Aprovados</option>
                  </select>
            </div>
