            ...
            <form action="">
                <div class="holNom">
                        <div id="holerite">
                            ...
                            <input type="number" name="hol" id="hol" placeholder="Seu Holerite" required>
                        </div>
                        <div id="nome">
                ...
                <div class="holNom">
                    <div id="tel">
                        ...
                        <input type="tel" name="tel" id="tel" placeholder="Telefone da escola" required>
                    </div>
                    <div id="email">
                ...
                <div id="equpmt">
                    ...
                    <select name="escola" id="escola">
                        <option style="display:none">Escolha o equipamento</option>
                ...
                <div class="quantVol">
                    <div id="quantidade">
                        ...
                        <input type="number" name="quant" id="quant" placeholder="quant de equipamentos" required>
                    </div>
                    <div class="eltVolt"> 
                        <div id="eletrico">
