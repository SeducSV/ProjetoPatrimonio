...
<head>
    ...
    <link rel="stylesheet" href="pastas/css/solicitante.css">
...
<body onresize="mudouTamanho()">
    ...
    <main>
        <section>
            ...
            <hr>
            <form action="" onsubmit="Solicitante()" autocomplete="off">
                <div class="holNom">
                    <div id="holerite">
                        <label for="hol">Holerite:</label>
                        <input type="number" name="hol" id="hol" placeholder="Seu Holerite" maxlength="5"
                    ...
                    <div id="nome">
                        ...
                        onkeypress="return (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 32 || (event.charCode >= 192 && event.charCode <= 252)" required>
                    </div>
                 </div>
                <div class="holNom">
                    <div id="tel">
                        <label for="tel">Telefone:</label>
                        <input type="tel" name="tel" id="tel" placeholder="Telefone da escola" minlength="14"
                            onkeyup="handlePhone(event)" maxlength="15" required>
                    </div>
                    <div id="email">
                        <label for="email">Email:</label>
                        <input type="text" name="email" id="email" placeholder="Email da escola" required>
                    </div>
                </div>
                <div id="escola">
                    <label for="escola">Escola:</label>
                    <select name="escola" id="escolher-escola" required>
                        <option style="display:none" value='' disabled selected>Escolha a escola</option>
                ...
                <h2>Solicite o Equipamento </h2>
                <hr>
                <div id="equpmt">
                    <label for="solicite">Solicite:</label>
                    <select name="equipamento" id="equipamento" required>
                    <option style="display:none" value='' disabled selected>Escolha o equipamento</option>
                ...
                <div class="quantVol">
                    <div id="quantidade">
                        ...
                        <input type="number" name="quant" id="quant" placeholder="quant de equipamentos"
                            onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
                    </div>
                    <div class="eltVolt">
                        <div id="eletrico">
                            ...
                            <input type="radio" name="radio" id="nao" value="nao" checked>
                ...
                <div id="observacao">
                    ...
                    <textarea name="obs" id="obs" rows="2"></textarea>
                </div>
    ...
    <script src="pastas/javascript/solicitante.js"></script>
</body>
